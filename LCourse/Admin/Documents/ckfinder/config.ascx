...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        BaseDir = Server.MapPath("/Documents/");
		...
		// The * and ? wildcards are accepted.
		HideFiles = new string[] { ".*" ,"*.flashpaper.swf","*.flashpaper.version"};
        ...
        allTypes.AddRange(LCourse.Private.LoadDocument.docType);
        allTypes.AddRange(LCourse.Private.LoadDocument.mediaType);
        allTypes.AddRange(LCourse.Private.LoadDocument.flashType);
        allTypes.AddRange(LCourse.Private.LoadDocument.iframeType);
        allTypes.AddRange(LCourse.Private.LoadDocument.imageType);
        allTypes.AddRange(LCourse.Private.LoadDocument.redirectType);
        
        
		type = ResourceType.Add( "课程概况" );
        type.Url = BaseUrl + "课程概况/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "课程概况\\";
		type.MaxSize = 0;
        type.AllowedExtensions = allTypes.ToArray();
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "课程学习" );
        type.Url = BaseUrl + "课程学习/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "课程学习\\";
		type.MaxSize = 0;
        type.AllowedExtensions = allTypes.ToArray();
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "其他资源" );
        type.Url = BaseUrl + "其他资源/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "其他资源\\";
		type.MaxSize = 0;
        type.AllowedExtensions = allTypes.ToArray();
		type.DeniedExtensions = new string[] { };
        ...
        type = ResourceType.Add("嵌入图片");
        type.Url = BaseUrl + "images/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "images/";
        type.MaxSize = 0;
        type.AllowedExtensions = LCourse.Private.LoadDocument.imageType;
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("嵌入Flash");
        type.Url = BaseUrl + "flash/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "flash/";
        type.MaxSize = 0;
        type.AllowedExtensions = LCourse.Private.LoadDocument.flashType;
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("媒体文件");
        type.Url = "/Media/";//BaseUrl + "media/";
        type.Dir = Server.MapPath("/Media/"); //BaseDir == "" ? "" : BaseDir + "media/";
        type.MaxSize = 0;
        type.AllowedExtensions = LCourse.Private.LoadDocument.mediaContentType;
        type.DeniedExtensions = new string[] { };
	}
